...
switch ($number_of_boxes) {
    ...
    <div class="col-md-offset-4 col-md-4 featured-page vcenter col-sm-12">
        <a href="<?php echo esc_url(get_permalink(get_post(get_theme_mod('box-1-settings'))->ID)); ?>">
    ...
    <div class="col-md-4 vcenter col-sm-12">
        <a href="<?php echo esc_url(get_permalink(get_post(get_theme_mod('box-2-settings'))->ID)); ?>">
    ...
    case 3: ?>
    <div class="col-md-4 vcenter col-sm-12">
        <a href="<?php echo esc_url(get_permalink(get_post(get_theme_mod('box-1-settings'))->ID)); ?>"><div class="featured-page">
            <?php echo get_post(get_theme_mod('box-1-settings'))->post_title; ?></div>
        </a>
    </div>
    <div class="col-md-4 vcenter col-sm-12">
        <a href="<?php echo esc_url(get_permalink(get_post(get_theme_mod('box-2-settings'))->ID)); ?>"><div class="featured-page">
            <?php echo get_post(get_theme_mod('box-2-settings'))->post_title; ?></div>
        </a>
    </div>
    <div class="col-md-4 vcenter col-sm-12">
        <a href="<?php echo esc_url(get_permalink(get_post(get_theme_mod('box-3-settings'))->ID)); ?>"><div class="featured-page">
